...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './app-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPUSER actions', async () => {
      const expectedActions = [
        {
