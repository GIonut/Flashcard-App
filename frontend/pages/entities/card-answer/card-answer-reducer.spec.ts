...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDANSWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDANSWER actions', async () => {
      const expectedActions = [
        {
