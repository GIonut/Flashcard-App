...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './card-model-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDMODELHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDMODELHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDMODELHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDMODELHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDMODELHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDMODELHISTORY actions', async () => {
      const expectedActions = [
        {
