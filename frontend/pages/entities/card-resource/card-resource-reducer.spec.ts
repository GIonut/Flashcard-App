...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDRESOURCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDRESOURCE actions', async () => {
      const expectedActions = [
        {
