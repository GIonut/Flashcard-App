...
export const CardDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bachelorThesisApp.card.delete.question">Are you sure you want to delete this Card?</ModalBody>
      <ModalFooter>
