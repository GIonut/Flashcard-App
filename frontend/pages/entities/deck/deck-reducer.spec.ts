...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './deck.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECK_LIST actions', async () => {
    ...
    it('dispatches FETCH_DECK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DECK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DECK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DECK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DECK actions', async () => {
      const expectedActions = [
        {
