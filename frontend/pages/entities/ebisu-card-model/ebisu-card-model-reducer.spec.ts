...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EBISUCARDMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_EBISUCARDMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EBISUCARDMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EBISUCARDMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EBISUCARDMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EBISUCARDMODEL actions', async () => {
      const expectedActions = [
        {
