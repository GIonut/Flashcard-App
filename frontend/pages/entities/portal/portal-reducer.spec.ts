...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './portal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORTAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PORTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORTAL actions', async () => {
      const expectedActions = [
        {
