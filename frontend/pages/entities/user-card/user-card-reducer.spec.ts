...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-card.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCARD actions', async () => {
      const expectedActions = [
        {
